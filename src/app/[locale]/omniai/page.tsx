        ...
        <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
            ...
            <nav className="flex justify-between items-center px-[5%] py-4 bg-white/95 fixed top-0 w-full z-50">
                ...
                <div className="flex gap-8 items-center">
                    ...
                    <Link href="https://api.pandalla.ai/pricing"
                          className="text-sm text-gray-900 hover:text-blue-600 transition-colors">
                        模型价格
                    </Link>
                    <Link href="https://api.pandalla.ai/topup"
                          className="text-sm text-gray-900 hover:text-blue-600 transition-colors">
                        余额
                    </Link>
                </div>
            ...
            {/* Hero Section */}
            <section
                className="pt-32 pb-16 px-[5%] text-center relative min-h-screen flex flex-col items-center justify-center">
                ...
                <div className="max-w-3xl mx-auto mb-12 text-lg text-gray-700 leading-relaxed">
                    ...
                    <p>完全兼容各平台接口，零开发基础即可轻松接入。</p>
                    <p>不用担心网络问题，稳定快速，高效整合资源，助您轻松实现AI应用！！</p>
                </div>
